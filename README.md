...
## [Options](https://github.com/notharder/MuskEmpireBot/blob/main/.env-example)
| Option                  | Description                                                       |
|-------------------------|-------------------------------------------------------------------|
...
### Linux
1. Clone the repository: `git clone https://github.com/notharder/MuskEmpireBot.git && cd MuskEmpireBot`
...
## Running in Docker
```
$ git clone https://github.com/notharder/MuskEmpireBot.git
$ cd MuskEmpireBot
$ cp .env-example .env
...
## Manual installation
You can download [**Repository**](https://github.com/notharder/MuskEmpireBot) by cloning it to your system and installing the necessary dependencies:
```
$ git clone https://github.com/notharder/MuskEmpireBot.git
$ cd MuskEmpireBot
